...
# nohup python cudam_server.py -s 7 --partial_dataset_ratio=1 --torch_vision_dataset=1 --is_aug=1 --train_validation_split_point=40000 -i cuda7.ecs.vuw.ac.nz -p 8000 -g 0 >& log/nohup_cudam_server_7_8000_0.log &
# nohup python cudam_server.py -s 7 --partial_dataset_ratio=1 --torch_vision_dataset=1 --is_aug=1 --train_validation_split_point=40000 -i cuda7.ecs.vuw.ac.nz -p 8001 -g 1 >& log/nohup_cudam_server_7_8001_1.log &
# nohup python cudam_server.py -s 7 --partial_dataset_ratio=1 --torch_vision_dataset=1 --is_aug=1 --train_validation_split_point=40000 -i cuda7.ecs.vuw.ac.nz -p 8002 -g 2 >& log/nohup_cudam_server_7_8002_2.log &
